...
public class PersonaDB {
    ...
    public boolean insertar(String nombres, String apellidos, String fechaNac, String experiencia)  {
        try {
            ...
            System.out.println("ERROR CRÍTICO EN INSERTAR: " + e.getMessage());
            e.printStackTrace();
            return false;
        }
        return true;
    ...
    public boolean editar(String codigo, String nombres, String apellidos, String fechaNac, String experiencia) throws Exception {
        try {
            SimpleDateFormat formato = new SimpleDateFormat("yyyy-MM-dd");
            Date fecha = formato.parse(fechaNac);
